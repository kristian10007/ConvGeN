...
from ConvGenLib.interfaces import GanBaseClass
from ConvGenLib.dataset import DataSet
from ConvGenLib.NNSearch import NNSearch
            ...
            if discTrainCount > 0:
                for n in range(discTrainCount):
                    for min_idx in range(minSetSize):
                        ...
                        conv_samples = generator.predict(min_batch, batch_size=self.neb, verbose=0)
